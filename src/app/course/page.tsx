        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
                ...
                <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24">
                    ...
                    >
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-xl hover:from-teal-600 hover:to-cyan-600 transition-all transform hover:scale-105 shadow-lg shadow-teal-500/25"
                        >
            ...
            <section className="py-16 bg-gray-900/50">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    >
                        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center text-3xl font-bold text-white">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-gray-400">Microsoft Endpoint Management & Device Administration Expert</p>
                                ...
                                return (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="block h-full p-6 bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 rounded-2xl hover:border-teal-500/50 transition-all"
                                        >
            ...
            {/* Certification */}
            <section className="py-16 bg-gradient-to-r from-teal-500/10 via-cyan-500/10 to-teal-500/10">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold text-white mb-4">
                            Prepare for MD-102 Certification
                        </h2>
                        <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                            This training aligns with the Microsoft MD-102 Endpoint
                            Administrator certification exam. Master device management, app
                            deployment, and endpoint security to pass with confidence.
                        </p>
                        <Link
                            href={`/course/${courseData.modules[0]?.slug}/${firstLesson?.slug}`}
