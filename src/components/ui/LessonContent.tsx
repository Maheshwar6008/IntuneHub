...
const iconMap: Record<string, React.ElementType> = {
    ...
    KeyRound, Key, Fingerprint, Smartphone, ShieldCheck, UserPlus, UserMinus,
    UsersRound, Building, Eye, Network, Workflow, ToggleLeft, LogIn, LogOut,
    CircleUser, BadgeCheck, Timer, Hash,
    FileKey, Tag, Cloud, Bot, AppWindow,
    Crosshair, Radar, Swords, Monitor, AlertCircle, Bug, Terminal,
    Play, Pause, Cpu, Radio, Wifi, Server, HardDrive, FolderSearch,
};
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            >
                <div className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                    ...
                    <span className="text-teal-400">{lesson.title}</span>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-all ${isComplete
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2">
                                        {lesson.trainerNotes.questionsToAsk.map((question, index) => (
                                            <li key={index} className="flex items-start gap-2 text-sm text-gray-400">
                                                <HelpCircle className="w-3 h-3 mt-1 text-teal-400 flex-shrink-0" />
                                                <span>{question}</span>
                                            </li>
                                        ))}
                                    </ul>
            ...
            >
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="relative">
                                                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-teal-500/20 to-cyan-500/20 border border-teal-500/30 flex flex-col items-center justify-center">
                ...
                {/* Why It Matters */}
                <section className="bg-gradient-to-r from-teal-500/10 to-cyan-500/10 border border-teal-500/20 rounded-xl p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-4">
                    ...
                    {nextLesson ? (
                        <Link
                            ...
                            className="flex items-center gap-3 p-4 bg-gradient-to-r from-teal-500/10 to-cyan-500/10 border border-teal-500/30 rounded-xl hover:border-teal-500/50 transition-colors group"
                        >
